  ...
  return (
    <section className="features" id="features">
            <div>
                ...
                <div className="boxes">
                    <div className="box">
                        <img src="src/images/Decentralised.jpg" alt="" />
                    ...
                    <div className="box">
                        <img src="src/images/audit.jpg" alt="" />
                        <div className="box-desc">
                    ...
                    <div className="box">
                        <img src="src/images/realtime.png" alt="" />
                        <div className="box-desc">
                        ...
                        <div className="box">
                            <img src="src/images/verification.jpg" alt="" />
                            <div className="box-desc">
                        ...
                        <div className="box">
                            <img src="src/images/privacy.jpg" alt="" />
                            <div className="box-desc">
                        ...
                        <div className="box">
                            <img src="src/images/scalable.jpg" alt="" />
                            <div className="box-desc">
